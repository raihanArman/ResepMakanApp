...
public class TipsTrickAdapter extends RecyclerView.Adapter<TipsTrickAdapter.ViewHolder> {

    List<TipsTrick> tipsTrickList;
    Context context;

    public TipsTrickAdapter(List<TipsTrick> tipsTrickList, Context context) {
    ...
    @NonNull
    @Override
    public TipsTrickAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.tips_trick_layout_item, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TipsTrickAdapter.ViewHolder holder, final int position) {
